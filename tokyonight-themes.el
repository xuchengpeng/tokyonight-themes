...
(defconst tokyonight-themes-faces
  '(
    ...
    `(font-lock-constant-face ((,c :foreground ,blue2)))
    ...
    `(font-lock-function-name-face ((,c :foreground ,magenta)))
    `(font-lock-keyword-face ((,c :foreground ,purple)))
    `(font-lock-negation-char-face ((,c :inherit error)))
    `(font-lock-number-face ((,c :foreground ,fg)))
    `(font-lock-operator-face ((,c :foreground ,fg)))
    ...
    `(font-lock-regexp-grouping-backslash ((,c :foreground ,magenta)))
    `(font-lock-regexp-grouping-construct ((,c :foreground ,green1)))
    `(font-lock-string-face ((,c :foreground ,blue1)))
    `(font-lock-type-face ((,c :foreground ,teal)))
    `(font-lock-variable-name-face ((,c :foreground ,cyan)))
